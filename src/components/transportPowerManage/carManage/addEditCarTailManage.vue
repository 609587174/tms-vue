  ...
  <div id="addeditTailCarPage">
    <el-container>
      <el-header style="height:80px">
        <el-row>
          <el-col :span="1" class="left-arrow-d" @click="goDetalis('down')"><i class="icon-down-arrow"></i></el-col>
          <el-col :span="22">
            <p>{{titleType}}</p>
          </el-col>
        </el-row>
              ...
              <el-row :gutter="80">
                ...
                <el-col :span="8">
                  <el-form-item label="车辆归属:" prop="attributes">
                    <el-select v-model="tailCarFormStep.attributes.key" placeholder="请选择车辆归属">
              ...
              <el-row :gutter="80">
                ...
                <el-col :span="8">
                  <el-form-item label="车辆类型:" prop="vehicle_type">
                    <el-select v-model="tailCarFormStep.vehicle_type.key" placeholder="请选择车辆类型" @change="changeSelect">
              ...
              <el-row :gutter="80">
                <el-col :span="8">
                  <el-form-item label="运输介质:">
                    <el-select v-model="tailCarFormStep.trans_type.key" placeholder="请选择车辆类型">
