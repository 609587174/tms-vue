  ...
  <div>
    <div class="nav-tab">
      <el-tabs v-model="activeName" type="card" @tab-click="handleClick">
        <el-tab-pane label="托运方应收报表" name="meet"></el-tab-pane>
        <el-tab-pane label="回款管理" name="payment">
    ...
    <shipper-receivable-dialog :arap-dialog="arapDialog" v-on:closeDialogBtn="closeDialog" :arap-row="arapRow"></shipper-receivable-dialog>
  </div>
</template>
<script>
import shipperReceivableDialog from '@/components/arap/shipperReceivableDialog';
export default {
  name: 'receivableManage',
  components: {
    shipperReceivableDialog: shipperReceivableDialog
  },
  computed: {
  ...
  methods: {
    ...
    getList: function() {
      ...
      this.$$http('getShipperReceivableManageList', postData).then((results) => {
    ...
    handleClick: function(tab, event) {
      if (tab.name === 'meet') {
        this.$router.push({ path: "/arap/shipperReceivableManage/shipperReceivableList" });
      }
    },
