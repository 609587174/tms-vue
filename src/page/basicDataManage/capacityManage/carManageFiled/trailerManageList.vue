  ...
  <div>
    ...
    <div class="nav-tab-setting mt-25">
      ...
      <el-tabs v-model="activeName" @tab-click="clicktabs">
        <el-tab-pane label="牵引车管理" name="first"></el-tab-pane>
...
export default {
  ...
  methods: {
    addHeadCarPage: function() {
      // this.$router.push({ path: "/basicDataManage/capacityManage/carManage/editCarTailManage", query: { operate: 'add' } });
      window.open(`#/basicDataManage/capacityManage/carManage/editCarTailManage?operate=add`, '_blank')
    },
