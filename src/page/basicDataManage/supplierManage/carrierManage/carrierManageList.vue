  ...
  <div>
    <div class="nav-tab">
      <el-tabs v-model="activeName" type="card" @tab-click="handleClick">
        <el-tab-pane label="加油气公司" name="energy"></el-tab-pane>
        <el-tab-pane label="高速公司" name="tollfee"></el-tab-pane>
        <el-tab-pane label="承运商" name="carrierManage">
