          ...
          <div class="detail-main" v-loading="pageLoading">
            <el-container v-show="!pageLoading">
              <el-header>
                <el-row>
                  <el-col :span="3">
                    <router-link :to="{path: '/basicDataManage/supplierManage/energyManage/energyManageList'}">
...
export default {
  ...
  methods: {
    ...
    goEditDetail: function() {
      this.$router.push({ path: `/basicDataManage/supplierManage/energyManage/energyManageChange?operate=edit&energyId=${this.detailData.id}` });
    },
    getDetail:function(){
