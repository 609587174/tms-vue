...
export default {
  ...
  methods: {
    ...
    handleClick(tab, event) {
      ...
      }else if(tab.name === 'carrierManage'){
    ...
    addList() {
      // this.$router.push({ path: '/basicDataManage/supplierManage/tollfeeManage/tollfeeManageChange' });
       window.open(`#/basicDataManage/supplierManage/tollfeeManage/tollfeeManageChange`, '_blank')
    },
    handleMenuClick(row) {
      if (row.operator === 'check') {
        // this.$router.push({
        //   path: `/basicDataManage/supplierManage/tollfeeManage/tollfeeManageDetalis/${row.id}`,
        // });
         window.open(`#/basicDataManage/supplierManage/tollfeeManage/tollfeeManageDetalis/${row.id}`, '_blank')
      }
    }
  },
