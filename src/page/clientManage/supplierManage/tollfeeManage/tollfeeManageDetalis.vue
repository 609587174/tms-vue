  ...
  <div>
    <div class="nav-tab">
      <el-tabs v-model="activeName" type="card" @tab-click="clicktabs">
        <el-tab-pane label="高速费详情" name="first">
          <div class="detail-main" v-loading="pageLoading">
            <el-container v-show="!pageLoading">
              <el-header>
                <el-row>
                  <el-col :span="3">
                    <router-link :to="{path: '/clientManage/supplierManage/tollfeeManage/tollfeeManageList'}">
...
export default {
  ...
  methods: {
    ...
    goEditDetail() {
      this.$router.push({
        path: '/clientManage/supplierManage/tollfeeManage/tollfeeManageChange',
        query: {
          id: this.id
        }
      });
