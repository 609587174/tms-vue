            ...
            >
              ...
              >
                <template slot-scope="scope">
                  ...
                  <div v-else>
                    <span
                      v-if="item.param ==='is_matching'||item.param ==='is_travel'"
...
export default {
  ...
  methods: {
    ...
    exportData(type) {
      ...
      this.$$http("exportCorporate", postData)
        .then(results => {
          this.exportBtn = {
            text: "导出",
            isLoading: false,
    ...
    handleMenuClick(tpye, row) {
      if (tpye === "waybill") {
        ...
        window.open(
          `#/statistics/costManage/publicCostManage/oilGas/oilGasWaybillDetail/${
            row.waybill_id
          }`,
          "_blank"
        );
        ...
        window.open(
          `#/statistics/costManage/publicCostManage/oilGas/editOilGas?id=${
            row.id
          }`,
          "_blank"
        );
    ...
    getList() {
      ...
      this.$$http("getOilGasStatisticList", postData)
        .then(results => {
